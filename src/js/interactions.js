...
function handleChange(event) {
  ...
  if (event.target.matches("[data-work-act-source-job]")) {
    state.workActSourceJobId = event.target.value;
...
function selectWorkActContext(act) {
  state.selectedWorkActId = act.id;
  state.workActSourceJobId = act.jobId || state.workActSourceJobId;
