...
- `WORKSPACE_MODULES.md` - overview of every active workspace module: purpose, data ownership, visible UI, linked modules, and explicit non-goals.
...
- `WORK_ACTS_MODULE.md` - detailed specification for the Work Acts workspace: source service job context, concrete Work Act drafts, template copying, work rows, generated PDF handoff, and Documents custody boundary.
...
- `LINKING_AND_PIPELINE_LOGIC.md` - detailed linking and workflow logic across Service, Work Acts, Templates, future Work Equipment, Sales, Contracts, Documents, Finance, Parts, Calendar, Customers, Equipment, and Admin.
...
- If Work Act source drafts, Work Act rows/options, source service job selection, generated PDF handoff, or Work Act routing changes, update `WORK_ACTS_MODULE.md`.
...
- `Work Acts` owns concrete Work Act drafts generated from service job context and copied Templates.
...
- Source workflows create generated document drafts from structured records and reuse templates where applicable.
- `Documents` stores/searches/views/upload signed copies and owns document file custody.
- `Service`, `Sales`, `Contracts`, `Finance`, `Parts`, `Customers`, `Equipment`, and `Calendar` own their domain records.
